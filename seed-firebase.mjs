...
const defaultData = {
  website: {
    ...
    blogs: {
      ...
      blogsList: [
        { title: "Is Data Entry Still a Reliable Way to Earn in 2026?", desc: "Ghar baithe data entry kaam shuru karne se pehle ye basic rules samajhna bahut zaroori hai. Simple steps to avoid scams.", tag: "Work From Home", url: "blogs/work-from-home.html", date: "2026" },
        { title: "The Truth About Online Typing Jobs: Scams vs. Opportunities", desc: "Kaise pehchanein ki typing platform real hai ya fake? Humne 10 alag-alag portals ko test kiya aur ye sachai saamne aayi.", tag: "Typing Jobs", url: "blogs/online-typing-job-real-or-fake.html", date: "2026" },
        { title: "Why Captcha Filling is Usually a Waste of Time (And What to Do Instead)", desc: "Agar aap har din 2 ghante captcha fill karte hain, toh aapki monthly income kitni hogi? An honest math breakdown.", tag: "Safety Guide", url: "blogs/captcha-work-safe-or-not.html", date: "2026" },
        { title: "How Form Filling Scams Trap Beginners (And How to Protect Yourself)", desc: "Security deposit aur registration fees ke naam par hone wale froud se kaise bachein? Real rules of form filling work.", tag: "Form Filling", url: "blogs/form-filling-job-real-or-fake.html", date: "2026" },
        { title: "Getting Started on WorkDen: A Step-by-Step Walkthrough", desc: "Registration se lekar live tasks complete karne aur payment withdraw karne tak ka poora transparent zero-risk process.", tag: "WorkDen", url: "blogs/work-from-home-opportunity-workden.html", date: "2026" },
        { title: "5 High-Paying Remote Jobs Anyone Can Do Without a Degree", desc: "Ghar se remote work shuru karne ke liye degree zaroori nahi hai. Ye 5 options bina heavy skills ke shuru ho sakte hain.", tag: "Beginners", url: "blogs/work-from-home-jobs-for-beginners.html", date: "2026" },
        { title: "Ghar Baithe Income: Realistic Ways to Make ₹15,000/Month Online", desc: "Bina kisi froud ya hidden charges ke India mein online earning karne ke realistic aur practical tarike jo sach me kaam karte hain.", tag: "Earning Tips", url: "blogs/ghar-baithe-online-paise-kaise-kamaye.html", date: "2026" },
        { title: "Comparing Verified Freelancing & Micro-Task Platforms in India", desc: "Upwork, Fiverr aur local micro-task platforms ke beech ka safety and transparency comparison. Kaunsa option safe hai?", tag: "Platforms", url: "blogs/online-earning-platforms-in-india.html", date: "2026" },
        { title: "Why We Built WorkDen: Simplicity and Support for Remote Workers", desc: "Naye freelancers ke liye remote work complex lagta hai. Humne unki basic problem ko live support aur task system se solve kiya.", tag: "WorkDen", url: "blogs/how-workden-helps-beginners-online-work.html", date: "2026" },
        { title: "How to Balance a Part-Time WFH Job with Your Full-Time Routine", desc: "College classes ya full-time naukri ke saath flexible hours me online micro-tasks kaise manage karein? Practical time tips.", tag: "Part Time", url: "blogs/part-time-job-work-from-home.html", date: "2026" },
        { title: "Best Side Hustles for Indian Students to Earn Pocket Money", desc: "Padhai ke saath flexible timing me pocket money earn karne ke safe alternatives. No investments required.", tag: "Students", url: "blogs/work-from-home-for-students.html", date: "2026" },
