...
const defaultData = {
  website: {
    ...
    blogs: {
      ...
      blogsList: [
        { title: "WhatsApp aur Telegram par Data Entry Jobs ke Naam Par ₹3,000 Security Deposit Maang Rahe Hain? Bilkul Mat Dena!", desc: "Telegram groups par daily ₹1,500-₹2,000 kamane ke jhaanse mein aane se pehle ye post padhein. Jaaniye fake registration fee scams kaise kaam karte hain aur khud ko kaise safe rakhein.", tag: "Job Scams Alert", url: "blogs/work-from-home.html", date: "2026" },
        { title: "WorkDen Real or Fake? An Honest Inside Look at Our Registration & Task Verification System", desc: "Bahut se users puchte hain ki kya WorkDen par sach mein kaam milta hai? Humne is post mein hamara operational model, GST registration aur task approvals ki puri process share ki hai.", tag: "WorkDen Verification", url: "blogs/online-typing-job-real-or-fake.html", date: "2026" },
        { title: "Mera Personal Experience: Kaise Maine Mobile Phone se Form Filling Karke Monthly Pocket Money Earn Kiya", desc: "Jaipur ke college student Aarav ki kahani, jinhone laptop na hone par bhi mobile app se daily 2 ghante form filling tasks kiye aur ₹4,200/month tak pocket money banayi.", tag: "User Story", url: "blogs/captcha-work-safe-or-not.html", date: "2026" },
        { title: "Online Typing Work Guide: Kaise Type Karein ki Aapki Accuracy 95% Se Jyada Rahe Aur Tasks Reject Na Ho", desc: "Demo tasks mein baar-baar low accuracy aa rahi hai? Humne practical tips share kiye hain jisse aap typing speed aur text alignment thik karke task approval rate badha sakte hain.", tag: "Task Tutorials", url: "blogs/form-filling-job-real-or-fake.html", date: "2026" },
        { title: "Housewives Ke Liye Work From Home: Ghar Ke Kaam Ke Sath Daily 2-3 Ghante Kaise Manage Karein?", desc: "Mumbai ki Anjali Verma se seekhein time management. Unhone kitchen ke kaamo aur bachon ki classes ke beech micro-tasks ke liye target schedule banakar consistent earning ki.", tag: "Housewife Guide", url: "blogs/work-from-home-opportunity-workden.html", date: "2026" },
        { title: "The Reality of Captcha Entry: 5 Hours of Work for Just ₹30? Why You Should Stop Doing It Immediately", desc: "Agar aap abhi bhi captcha filling websites par apna time waste kar rahe hain, toh ye statistics dekh lijiye. Kyun micro-tasks aur typing projects isse 10x behtar option hain.", tag: "Earning Truths", url: "blogs/work-from-home-jobs-for-beginners.html", date: "2026" },
        { title: "Online Fraud Kaise Report Karein? Cyber Crime Portal (cybercrime.gov.in) par Complaint Darj Karne ka Step-by-Step Tarika", desc: "Agar kisi fake company ne security deposit lekar aapko block kar diya hai, toh dariye mat. Hamari detailed guide se seekhein cyber cell mein refund aur complaint kaise file karein.", tag: "Legal Help", url: "blogs/ghar-baithe-online-paise-kaise-kamaye.html", date: "2026" },
        { title: "How to Withdraw Your Earnings on WorkDen: Step-by-Step UPI and Direct Bank Transfer Process", desc: "Hamara payout system kaise kaam karta hai? Minimum withdrawal limits, auto-payment schedules aur bank transfer details ke saare doubts clear karein is simple post se.", tag: "Payout Help", url: "blogs/online-earning-platforms-in-india.html", date: "2026" },
        { title: "Data Entry Tasks Me Sabse Jyada Hone Wali 5 Choti Galtiyan Jo Aapka Payout Rok Sabti Hain", desc: "Aadhar number copy karte waqt space chhorna, ya spelling mistakes karna — ye aisi galtiyan hain jo manual review mein cards reject karwa deyte hain. Inhe kaise avoid karein?", tag: "Quality Tips", url: "blogs/how-workden-helps-beginners-online-work.html", date: "2026" },
        { title: "Part-Time WFH Jobs vs Full-Time Permanent Jobs: Kaun Sa Option Aapke Liye Behtar Hai?", desc: "Freelance micro-tasking aur structured permanent jobs ke beech ke flexibility, rules, aur payout difference ko samajhein aur apne convenience ke hisab se decision lein.", tag: "Career Advice", url: "blogs/part-time-job-work-from-home.html", date: "2026" },
        { title: "Student Budget Hack: College Fees Aur Books Ke Liye Self-Dependent Kaise Banein", desc: "Bina parents par dependent hue, college hours ke baad 1.5 ghante genuine typing projects karke monthly small bills aur online courses ki fees khud pay karne ki practical steps.", tag: "Student Corner", url: "blogs/work-from-home-for-students.html", date: "2026" },
        { title: "Flexible Remote Tasks Perfect for Housewives & Homemakers", desc: "Ghar ke kaamo ke beech me 2-3 ghante nikal kar safe workflow ke saath remote tasks manage karne ki genuine possibilities.", tag: "Housewives", url: "blogs/work-from-home-for-housewives.html", date: "2026" }
      ]
    },
    "demo-task": {
