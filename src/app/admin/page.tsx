...
const DEFAULT_CONTENT: Record<string, any> = {
  ...
  "demo-task": {
    ...
    loginHeroTitle: "Official Candidate Practice Portal",
    loginHeroDesc: "Welcome to the WorkDen Demo Tasks workspace. Register or login to access your interactive mock task database and refine your digital skills.",
    loginStatusText: "Practice Node Online",
    loginBadge1: "100% Free Demo",
    loginBadge2: "Secure Session",
    loginFeat1Title: "Mock Practice Tasks",
    loginFeat1Desc: "Gain hands-on experience with Typing, Form Filling, Data Entry, and Grammar tasks under real-time conditions.",
    loginFeat2Title: "Live Accuracy Engine",
    loginFeat2Desc: "Calculates precision ratings, spelling metrics, and character comparisons on-the-fly to show where you need to improve.",
    loginFeat3Title: "Sync History & Progress Drawer",
    loginFeat3Desc: "All mock attempts are permanently saved on the cloud. Sync and track your accuracy history inside your personal dashboard drawer.",
